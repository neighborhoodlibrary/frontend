    ...
    return (
      <AddBookCardDiv>
        <Card className="heightLimiter">
          <CardHeader tag="h4">{this.props.book.title}</CardHeader>
          <CardHeader tag="h6">{this.authors()}</CardHeader>
          <div class="imghold">
            <BookCover alt="thumbnail" src={this.coverPull()} />
          </div>
          <CardBody>
            <Collapse isOpen={this.state.collapse}>
              ...
              <CardHeader>
                Published: {this.props.book.first_publish_year}
              </CardHeader>
              <CardHeader>Description: </CardHeader>
              <div class="descHold">{this.props.book.description}</div>
            ...
            <div class="buttonz">
              ...
              <Button color="success" onClick={this.togglem}>
                Add Book
              </Button>
              <Modal
              ...
              >
                ...
                <ModalBody>
                  Are you sure you want to add {this.props.book.title} to your
                  library?
                </ModalBody>
                <ModalFooter>
                  <AddBookButton
                  ...
                  />{" "}
                  <Button color="danger" onClick={this.togglem}>
                    Cancel
                  </Button>
                </ModalFooter>
              </Modal>
